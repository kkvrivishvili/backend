...
-- necesarias para el sistema Linktree AI en Supabase, incluyendo soporte para acceso público.
...
-- Tabla base de tenants (esquema público) con campos para acceso público
...
-- Función para incrementar tokens usados para un tenant (para acceso público)
